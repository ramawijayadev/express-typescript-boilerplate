        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    for (i = 1; i <= count; i++) {
                        examples.push({
                            name: "Example ".concat(i),
                            description: "This is the description for example ".concat(i),
                        });
                    }
                    // Using createMany for better performance
                    return [4 /*yield*/, prisma.example.createMany({
                            data: examples,
                        })];
                case 1:
                    // Using createMany for better performance
                    _a.sent();
                    console.log("Seeded ".concat(count, " examples."));
                    return [2 /*return*/];
            }
        });
    });
